...
Vector* fl1 = new Vector(0.0f, 0.0f, 0.0f);
Vector* fl2 = new Vector(0.0f, -0.5f, 0.5f);
Vector* fl3 = new Vector(-0.5f, -0.5f, 0.0f);
Vector* fr1 = new Vector(0.0f, 0.0f, 0.0f);
Vector* fr2 = new Vector(0.0f, -0.5f, 0.5f);
Vector* fr3 = new Vector(0.5f, -0.5f, 0.0f);
Vector* bl1 = new Vector(0.0f, 0.0f, 0.0f);
Vector* bl2 = new Vector(-0.5f, -0.5f, 0.0f);
Vector* bl3 = new Vector(0.0f, -0.5f, -0.5f);
Vector* br1 = new Vector(0.0f, 0.0f, 0.0f);
Vector* br2 = new Vector(0.5f, -0.5f, 0.0f);
Vector* br3 = new Vector(0.0f, -0.5f, -0.5f);
